<?php
	...
	$pdf = new mPDF('utf-8', array(210,279), '', '', '25','25','80','40','21','25');
	...
	$headerHTML='<div class="logo"><img src = "../images/logos/'.$logo.'" height = "80px"/></div>'.printAndOrganizeHeader($currentData[0]);
	...
	*/
	/*
	$stylesheet = file_get_contents('../css/brief_pdf.css');
	...
	*/	
	$pdf->WriteHTML($html);
	$pdf->Output('BRIEF OT '.$_GET['ot'].'.pdf', 'I');
?>