<?php
					...
					<td style ="padding-left:5px;" colspan = "2">
						<table width = "100%">
							...
							<tr>
								...
								<td style = "padding-left:10px;">PAOLA PAEZ</td>
					...
					<td>
						<table width = "100%">
							...
							<tr>
								...
								<td style = "padding-left:10px;">'.date("Y-m-d").'
	...
	$footerHTML='<div class="footerText"><strong>'.$observaci.'<strong></div><div style="text-align:right" >{PAGENO}</div>';	
