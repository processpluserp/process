		...
		$xt .='<tr  class = "salto">
			...
			<tr class = "salto">
				...
				<td style = "border:1px solid black;">
					<table width = "100%" class ="internos" style = "font-weight:bold;">
						<tr>
							<td align = "left" width = "2%">$</td><td align = "right">'.number_format((($acumxx+$accc)*16)/100).'</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td style = "border:1px solid black;" >
					<table width = "100%" class ="internos" style = "font-weight:bold;">
						<tr>
							...
							number_format((((($acumxx*$comision)/100)*16)/100) + (($acumxx*$comision)/100) + (($acumxx*16)/100) + $acum + $accc).'</td>
						</tr>
					</table>
				</td>
			</tr>
		...
		$xt.='<tr  class = "salto">
			...
			<tr class = "salto">
				...
				<td style = "border:1px solid black;" >
					<table width = "100%" class ="internos" style = "font-weight:bold;">
						<tr>
							<td align = "left" width = "2%">$</td><td align = "right">'.number_format(($comi*16)/100).'</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr class = "salto">
				...
				<td style = "border:1px solid black;" >
					<table width = "100%" class ="internos" style = "font-weight:bold;">
						<tr>
							<td align = "left" width = "2%">$</td><td align = "right">'.
							number_format((((($comi))*16)/100) + ($comi) + (($acumxx*16)/100) + $acumxx + $accc).'</td>
						</tr>
					</table>
				</td>
			</tr>
