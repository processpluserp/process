	...
	switch ($turno){
			...
			if($_POST['test'] == 1){
				...
				if($_POST['num_ppto'] == 0){
					...
					if($_POST['tipo'] == 33 && count($_FILES['arc0']['name']) > 0){
						mysql_query("update cabpresup set estado_presup = '3' where codigo_presup = '$pptox'");
					}
		...
		case 29:
			...
			if($vari == 3){
				...
				echo "NO SE PUDO ENVIAR EL INFORME";
			}
			break;
		case 30:
			$ot = new cabecera_ot();
